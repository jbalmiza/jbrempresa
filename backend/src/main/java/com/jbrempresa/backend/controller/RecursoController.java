...
public class RecursoController {
 ...
 @GetMapping public List<RecursoOperativo> consultar(){Long empresa=contexto.empresaConsulta(null);return empresa==null?recursos.findByReoActTrueOrderByEmpIdAscReoNomAsc():recursos.findByEmpIdAndReoActTrueOrderByReoNom(empresa);}
