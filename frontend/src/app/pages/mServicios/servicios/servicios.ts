...
export class Servicios {
 ...
 private vacio():Servicio{return {empId:Number(localStorage.getItem('empresaId'))||0,serId:0,serIdHis:1,serTipMov:'A',serCauMov:'Alta del registro',serTipSer:'',serNom:'',serDes:'',serCat:'',serSubCat:'',serDurMin:5,serPreVen:0,serPreDes:0,serPreIva:21,serPreFin:0,serObs:'',serVisCat:true,serNov:false,serMejPre:false,serOut:false,serIma:'servicio-predeterminado.png',serUsuMov:localStorage.getItem('usuario')||'',serFecMov:FechasUtil.formatearFechaHora(),serAct:true};}
