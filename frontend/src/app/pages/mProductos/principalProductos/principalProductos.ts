...
@Component({
  selector: 'PrincipalProductos', // Nombre HTML del componente
  ...
  templateUrl: './principalProductos.html', // Archivo HTML que usa este componente.
  styleUrl: './principalProductos.css' // Archivo CSS que usa este componente.
})

// Definición de la lógica del componente 
export class PrincipalProductos {
