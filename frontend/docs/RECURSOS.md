...
El formulario agrupa `Id Empresa` e `Id Recurso` en Datos Identificación; añade `Id Histórico` exclusivamente en Gestión. `Código` forma parte de Datos Recurso junto a Tipo, Nombre, Persona y Descripción.
